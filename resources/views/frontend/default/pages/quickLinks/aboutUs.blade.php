...
@section('contents')
            ...
            <div class="row g-4">
              <div class="col-md-6">
                <div class="image-box py-6 px-4 image-box-border">
                  <div class="icon position-relative d-inline-flex">
                    <img src="{{ staticAsset('frontend/default/assets/img/icons/hand-icon.svg') }}" alt="hand icon"
                      class="img-fluid">
  ...
  <section class="counter-one section-space">
    <div class="counter-one__bg boskery-jarallax" data-jarallax data-speed="0.3"
      data-background="{{ staticAsset('frontend/freshmeat/assets/images/backgrounds/counter-bg-2.jpg') }} style="background-image:
      url();"></div><!-- /.counter-one__bg -->
    <div class="container">
      <div class="counter-one__wrapper">
        ...
        <div class="counter-one__item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="400ms">
          <div class="counter-one__item__inner">
            ...
            <h4 class="counter-one__title">Happy customers</h4><!-- /.counter-one__title -->
          </div><!-- /.counter-one__item__inner -->
        </div><!-- /.counter-one__item -->
        <div class="counter-one__item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
          <div class="counter-one__item__inner">
            ...
            <h4 class="counter-one__title">Meat products</h4><!-- /.counter-one__title -->
          </div><!-- /.counter-one__item__inner -->
        </div><!-- /.counter-one__item -->
    ...
    <div class="container">
      <div class="brand-wrapper px-5 rounded-4">
        ...
        <div class="brands-slider swiper px-2 pt-4 pb-7">
          @php
            $about_popular_brand_ids =
                getSetting('about_popular_brand_ids') != null ? json_decode(getSetting('about_popular_brand_ids')) : [];
        ...
        @foreach ($features as $feature)
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="horizontal-counter d-flex align-items-center gap-3 bg-white rounded p-4">
              <span class="icon-wrapper d-inline-flex align-items-center justify-content-center rounded-2 flex-shrink-0">
              ...
              <div class="d-flex align-items-center gap-2 flex-wrap mb-2">
                ...
                <span>
                  <svg width="58" height="10" viewBox="0 0 58 10" fill="none"
                    ...
                    <line x1="-6.99382e-08" y1="5.2" x2="52" y2="5.2" stroke="#FF7C08"
                      stroke-width="1.6" />
                ...
                <div class="col-md-6">
                  <div
                    ...
                    <span class="icon-wrapper position-relative flex-shrink-0">
                      <img src="{{ uploadedAsset($each_why_choose_us->image) }}" alt="" class="img-fluid">
                    </span>
