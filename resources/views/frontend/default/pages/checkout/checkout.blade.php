    ...
    <div class="checkout-section ptb-120">
      <div class="container">
        <div class="row g-4">
          ...
          <div class="col-xl-8">
            <div class="checkout-steps">
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <div class="tt-address-content">
                      <input type="radio" class="tt-custom-radio" name="shipping_address_id"
                        ...
                        onchange="getLogistics({{ $address->city_id }})" @if ($address->is_default) checked @endif
              ...
              <div class="row g-4">
                <div class="col-12">
                  <div class="tt-address-content">
                    <input type="radio" class="tt-custom-radio" name="shipping_delivery_type" id="regular-shipping"
                ...
                @if (getSetting('enable_scheduled_order') == 1)
                  <div class="col-12">
                    <div class="tt-address-content">
                      <input type="radio" class="tt-custom-radio" name="shipping_delivery_type" id="scheduled-shipping"
                        value="scheduled">
                ...
                <div class="row g-4">
                  <div class="col-sm-6">
                    <div class="label-input-field">
                      ...
                      <input type="text" name="phone" placeholder="{{ localize('Phone Number') }}"
          ...
          <!-- order summary -->
          <div class="col-xl-4 card shadow">
