  ...
  <section class="my-account pt-6 pb-120">
    <div class="container">
      ...
      <div class="row g-4">
        ...
        <div class="col-xl-9">
          <div class="address-book bg-white rounded p-5 shadow">

            <div class="d-flex justify-content-between">
              <h4 class="mb-5">{{ localize('Address Book') }}</h4>
              <a href="javascript:void(0);" onclick="addNewAddress()" class="fw-semibold"><i class="fas fa-plus me-1"></i>
                {{ localize('Add Address') }}</a>
            </div>
            <div class="row g-4">
                  ...
                  <div class="tt-address-content border p-3 rounded address-book-content pe-md-4 position-relative">
                    <div class="address tt-address-info position-relative">
                      ...
                      <div class="tt-edit-address position-absolute">
                        ...
                        <a href="javascript:void(0);" data-url="{{ route('address.delete', $address->id) }}"
                          onclick="deleteAddress(this)" class="text-danger">{{ localize('Delete') }}</a>
                      </div>
                    </div>
                  </div>
                </div>
