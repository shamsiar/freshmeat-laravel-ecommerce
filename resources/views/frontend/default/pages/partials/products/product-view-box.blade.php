<div class="gstore-product-quick-view bg-glimpse-pink rounded-3 p-4 shadow">
  <div class="row g-4">
    ...
    <div class="col-xl-6">
      <div class="product-info">
        <h3 class="my-3">{{ $product->collectLocalization('name') }}</h3>

        <!-- pricing -->
        <div class="pricing all-pricing my-3">
        ...
        <form action="" class="add-to-cart-form">
          ...
          <div class="d-flex align-items-center gap-3 flex-wrap mt-5">
            ...
            <button type="submit" class="product-details__btn boskery-btn add-to-cart-btn"
              ...
              <span class="boskery-btn__hover"></span>
              <span class="boskery-btn__hover"></span>
              <span class="boskery-btn__text add-to-cart-text">
            ...
            <button type="button" class="btn btn-danger btn-lg" onclick="addToWishlist({{ $product->id }})">
