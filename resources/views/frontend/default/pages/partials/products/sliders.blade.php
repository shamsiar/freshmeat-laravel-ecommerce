    ...
    <div class="swiper-wrapper">
      @forelse($galleryImages as $galleryImage)
        <div class="swiper-slide text-center">
          <img src="{{ uploadedAsset($galleryImage) }}" alt="{{ $product->collectLocalization('name') }}" loading="lazy"
            class="img-fluid">
        </div>
      @empty
        <div class="swiper-slide text-center">
