@forelse ($carts as $cart)
  ...
  <li class="d-flex align-items-center pb-3 @if (!$loop->first) pt-3 @endif">
    <div class="thumb-wrapper border-1 border-danger">
    ...
    <div class="items-content ms-3">
      ...
      <div class="products_meta mt-1 d-flex align-items-center">
        <div>
          <span
            class="price text-danger fw-semibold">{{ formatPrice(variationDiscountedPrice($cart->product_variation->product, $cart->product_variation)) }}</span>
