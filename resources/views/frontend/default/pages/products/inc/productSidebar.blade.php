<div class="gshop-sidebar bg-white rounded-2 overflow-hidden">
  <!--Filter by search-->
  <div class="sidebar-widget search-widget sidebar__single shadow round-5">
  ...
  <div class="sidebar-widget category-widget sidebar__single shadow round-5 mobile-menu-wrapper scrollbar h-400px">
    <div class="widget-title d-flex">
    ...
    <ul class="widget-nav mt-4">
      ...
      @php
        $product_listing_categories =
            getSetting('product_listing_categories') != null
                ? json_decode(getSetting('product_listing_categories'))
                : [];
  ...
  <!--Filter by Categories-->
  <!--Filter by Price-->
  <div class="sidebar-widget price-filter-widget sidebar__single shadow round-5">
    <div class="widget-title d-flex">
    ...
    <div class="at-pricing-range mt-4">
      <form class="range-slider-form">
        ...
        <button type="submit" class="boskery-btn product__item__link mt-3">{{ localize('Filter') }}</button>
      </form>
    </div>
  </div>
  <!--Filter by Price-->
  <!--Filter by Tags-->
  <div class="sidebar-widget tags-widget sidebar__single shadow round-5">
    <div class="widget-title d-flex">
