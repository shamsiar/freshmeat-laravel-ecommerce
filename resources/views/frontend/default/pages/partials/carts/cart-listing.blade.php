  ...
  <tr>
    <td class="h-100px">
      <img src="{{ uploadedAsset($cart->product_variation->product->thumbnail_image) }}"
        alt="{{ $cart->product_variation->product->collectLocalization('name') }}" class="img-fluid" width="100">
    </td>
    ...
    <td>
      ...
      <span class="text-warning fw-bold"><button type="button" class="close-btn ms-3"
          onclick="handleCartItem('delete', {{ $cart->id }})"><i class="fas fa-close"></i></button></span>
    </td>
  </tr>
@empty
  <tr>
