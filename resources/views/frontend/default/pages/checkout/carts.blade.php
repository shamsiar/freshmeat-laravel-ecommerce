...
@section('contents')
  ...
  <section class="cart-section ptb-120">
    <div class="container">
      <div class="row rounded-2 overflow-hidden card shadow">
      ...
      <div class="row g-4">
        <div class="col-xl-6 card shadow">
          <div class="voucher-box py-7 px-5 position-relative z-1 overflow-hidden bg-white rounded mt-4">
            <img src="{{ staticAsset('frontend/default/assets/img/shapes/circle-half.png') }}" alt="circle shape"
            ...
            <form class="d-flex align-items-center coupon-form">
              ...
              <input type="text" name="code" placeholder="{{ localize('Enter Your Coupon Code') }}"
                class="theme-input w-100 coupon-input cart-cupon__coupone__input"
                @if (isset($_COOKIE['coupon_code'])) value="{{ $_COOKIE['coupon_code'] }}" disabled @endif required>

              @if (isset($_COOKIE['coupon_code']))
                <button type="submit" class="boskery-btn flex-shrink-0 apply-coupon-btn d-none px-4">
                  ...
                  <span class="boskery-btn__hover"></span>
                  <span class="boskery-btn__hover"></span>
                  <span class="boskery-btn__text">{{ localize('Apply Coupon') }}</span>
                </button>
                <button type="button" class="boskery-btn flex-shrink-0 clear-coupon-btn"><i
                    class="fas fa-close"></i></button>
              @else
                <button type="submit" class="boskery-btn flex-shrink-0 apply-coupon-btn px-4">
                  <span class="boskery-btn__hover"></span>
                  <span class="boskery-btn__hover"></span>
                  <span class="boskery-btn__hover"></span>
                  <span class="boskery-btn__hover"></span>
                ...
                <button type="button" class="boskery-btn flex-shrink-0 clear-coupon-btn d-none"><i
                    class="fas fa-close"></i></button>
              @endif
            </form>
            <!-- coupon form -->
        ...
        <div class="col-xl-6 card shadow">
          <div class="cart-summery bg-white rounded-2 pt-4 pb-7 px-5 mt-4">
            ...
            <div class="btns-group d-flex flex-wrap gap-3">
              ...
              <a href="{{ route('home') }}" class="cart-page__update-btn boskery-btn flex-shrink-0 px-4 rounded-1"
                ...
                <span class="boskery-btn__hover"></span>
                <span class="boskery-btn__hover"></span>
                <span class="boskery-btn__text">{{ localize('Continue Shopping') }}</span>
              </a>

              <a href="{{ route('checkout.proceed') }}" type="submit" class="boskery-btn rounded-1">
                <span class="boskery-btn__hover"></span>
                <span class="boskery-btn__hover"></span>
                <span class="boskery-btn__hover"></span>
                <span class="boskery-btn__hover"></span>
