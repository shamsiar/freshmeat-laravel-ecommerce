<div
  class="vertical-product-card rounded-2 position-relative d-md-flex align-items-center bg-white hr-product product__item">
  ...
  <div class="card-content w-100 p-3">
    ...
    <h4 class="product__item__title mb-2">
      ...
      <form action="" class="direct-add-to-cart-form">
        ...
        @else
          <a href="javascript:void(0);" onclick="directAddToCartFormSubmit(this)"
            class="boskery-btn product__item__link direct-add-to-cart-btn add-to-cart-text">{{ localize('Add to Cart') }}
